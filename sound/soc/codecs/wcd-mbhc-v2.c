...
/*LINE<FFBAKK-176><20141030>
<fix bug SPK don't has sound when plug out earphone>xiongdajun*/
...
static void wcd_correct_swch_plug(struct work_struct *work)
{
	...
	/* Enable current source for detection in correct work*/
	snd_soc_update_bits(codec,
			MSM8X16_WCD_A_ANALOG_MBHC_FSM_CTL,
			0xB0, 0xB0);
...
static int wcd_mbhc_initialise(struct wcd_mbhc *mbhc)
{
	...
	snd_soc_write(codec, MSM8X16_WCD_A_ANALOG_MBHC_DBNC_TIMER, 0x94);//0x98 //LINE<><20141208><Headset button>wangyanhui

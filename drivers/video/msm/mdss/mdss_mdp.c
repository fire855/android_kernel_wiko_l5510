...
//Add By YangRujin Start : store lcd  info 
...
//Add By YangRujin Start : store lcd info 
	...
	if(!strncmp(pan_name+i+1, "mdss_dsi_otm1284a_720p_video", sizeof("mdss_dsi_otm1284a_720p_video"))){
		store_lcd_info("mdss_dsi_otm1284a_720p_video_BOE");
	}else{
		store_lcd_info(pan_name+i+1);
	}
#endif
//Add By YangRujin End.

...
struct mdss_dsi_ctrl_pdata {
	...
	struct dsi_panel_cmds status_cmds_two;
	u32 status_value_two;
	...
	int status_mode;
	//BEGIN <lcm> <DATE20141218> <read more register> limi.zhang
	struct dsi_buf status_buf_two;
	int status_mode_two;
	int status_read_mode;
	//LINE <LCM> <DATE20150203> <add TE check for lcm eds check> limi.zhang 
	int status_TE_mode; // add for te
    //END <lcm> <DATE20141218> <read more register> limi.zhang

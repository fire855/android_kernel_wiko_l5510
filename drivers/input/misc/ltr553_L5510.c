...
{ 5,  1000,  3000, 4500,  8000, 65535,  65535,  65535};
static uint16_t g_lux_to_sys_map[8] = 
{ 10,  1500,  3500,  5500,  8500,  20000,  20000,  20000};
...
static uint16_t read_als_adc_value(struct ltr553_data *ltr553)
{
	...
	pr_alert("after anti_bounce:vl_index= %d | orient_index=%d | value = %d", vl_index,orient_index, value);
